...
If you're developing a website or web application, you may use a front-end web development framework
 ...
 to reduce development efforts and conform to familiar web standards. Regardless of what kind of product you're making, you may also leverage any starter project code provided by the professor as the basis of your own product, as long as you provide proper attribution. If you're not sure where to start, feel free to ask the professor for support, including for some example code to help you get started!
